  ...
  return (
    <div className="portal-shell">
      ...
      <style>{`
        ...
        .portal-top .container { display: flex; align-items: center; gap: 40px; }
        ...
        .portal-nav { display: flex; gap: 24px; flex: 1; }
        .portal-nav a { font-size: 13px; color: var(--c-ink); padding: 6px 0; }
        .portal-nav a:hover { color: var(--c-gold); }
        .portal-right { display: flex; align-items: center; gap: 14px; }
        .portal-main { padding: 56px 0 96px; }
        @media (max-width: 980px) { .portal-nav { display: none; } }
      `}</style>
    </div>
  );
}
